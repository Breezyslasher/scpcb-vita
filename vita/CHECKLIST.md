...
| SCP-860-1, 1499-1 | missing (need their host dimensions) | 860-1 lives only in the SCP-860 forest dimension and 1499-1 only in the SCP-1499 mask dimension; neither dimension is ported, so the creatures have nowhere to spawn. Their models load; porting them means first building those two dimensions (like the pocket dimension) |
